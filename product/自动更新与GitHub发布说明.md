...
v0.11.0 开始，Windows 正式版默认每 6 小时检查一次固定 GitHub 仓库的最新正式 Release。v0.11.2 开始，老板还可以在 Codex 或网页连续对话中直接说：
...
“检查新版本”读取的是 GitHub 最新正式 Release，不读取开发分支或普通提交。因此开发代码上传后还必须通过测试并发布同版本标签，老电脑才会显示可安装的新版本。
